...
import com.xiaotiyun.school.manager.model.excel.StudentMedicalRecordImportPtModel;
...
public class StudentMedicalRecordImportPtListener extends AnalysisEventListener<StudentMedicalRecordImportPtModel> {
    @Getter
    private List<StudentMedicalRecordImportPtModel> dataList = new ArrayList<>();
    ...
    static {
        ...
        EXPECTED_HEADER.put(16, "Dor Abdominal");
    ...
    @Override
    public void invoke(StudentMedicalRecordImportPtModel data, AnalysisContext context) {
