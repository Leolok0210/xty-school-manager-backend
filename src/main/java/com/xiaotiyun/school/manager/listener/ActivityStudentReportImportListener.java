...
import com.xiaotiyun.school.manager.model.excel.ActivityStudentReportImportModel;
import lombok.Data;
...
public class ActivityStudentReportImportListener extends AnalysisEventListener<ActivityStudentReportImportModel> {
    // 存储期望的表头
    private static final Map<Integer, String> EXPECTED_HEADER = new HashMap<>();
    private List<ActivityStudentReportImportModel> dataList = new ArrayList<>();
    static {
    ...
    @Override
    public void invoke(ActivityStudentReportImportModel model, AnalysisContext context) {
    ...
    public void doAfterAllAnalysed(AnalysisContext context) {
        log.info("活动匹配导入数据解析完成，共{}条数据", dataList.size());
    }
} 