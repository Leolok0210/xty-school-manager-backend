...
import com.xiaotiyun.school.manager.model.excel.StudentRewardImportEnUsModel;
import lombok.Data;
...
public class StudentRewardImportEnUsListener extends AnalysisEventListener<StudentRewardImportEnUsModel> {
    // 存储期望的表头
    private static final Map<Integer, String> EXPECTED_HEADER = new HashMap<>();
    private List<StudentRewardImportEnUsModel> dataList = new ArrayList<>();
    ...
    static {
        ...
        EXPECTED_HEADER.put(4, "Type(required)\n" +
                "Enterable：Major Merit, Minor Merit, Commendation");
    ...
    @Override
    public void invoke(StudentRewardImportEnUsModel importZhTwModel, AnalysisContext analysisContext) {
