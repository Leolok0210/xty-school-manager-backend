...
import com.xiaotiyun.school.manager.model.excel.StudentPunishmentImportPtPtModel;
import lombok.Data;
...
public class StudentPunishmentImportPtPtListener extends AnalysisEventListener<StudentPunishmentImportPtPtModel> {
    // 存储期望的表头
    private static final Map<Integer, String> EXPECTED_HEADER = new HashMap<>();
    private List<StudentPunishmentImportPtPtModel> dataList = new ArrayList<>();
    ...
    static {
        ...
        EXPECTED_HEADER.put(4, "Tipo (obrigatório)\n" +
                "Introduzível：Falta Grave, Falta Leve, Ponto Disciplinar");
    ...
    @Override
    public void invoke(StudentPunishmentImportPtPtModel importZhTwModel, AnalysisContext analysisContext) {
